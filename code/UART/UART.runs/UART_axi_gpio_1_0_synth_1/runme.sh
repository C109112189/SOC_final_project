...
HD_PWD='C:/Xilinx/vivado/UART/UART.runs/UART_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_axi_gpio_1_0.tcl
